...
abstract class $CounterStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int count, CounterStatus status});
}
...
class _$CounterStateCopyWithImpl<$Res, $Val extends CounterState>
  ...
  @override
  $Res call({Object? count = null, Object? status = null}) {
    return _then(
      _value.copyWith(
            count: null == count
                ? _value.count
...
class _$CounterStateImpl implements _CounterState {
  const _$CounterStateImpl({required this.count, required this.status});
  ...
  @override
  String toString() {
    return 'CounterState(count: $count, status: $status)';
  }
...
abstract class _CounterState implements CounterState {
  const factory _CounterState({
    ...
    required final CounterStatus status,
  }) = _$CounterStateImpl;
